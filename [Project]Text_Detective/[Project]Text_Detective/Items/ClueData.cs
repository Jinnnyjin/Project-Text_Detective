...
namespace _Project_Text_Detective
{
    ...
    public static class ClueData
    {
        public static List<Clue> Tutoclues = new List<Clue>
        {
            ...
            new Evidence {Name = "충전기에 찍혀있는 지문", Description = " 피해자 지문 외의 [나사장]과 [알바생]의 지문도 추가검출 되었다.", Importance = ClueImportance.Critical },
            new Evidence {Name = "김단골의 스마트폰", Description = "배터리가 부족하다. 당장이라도 충전을 해야할 것 같다. ", Importance = ClueImportance.Minor },
            new Evidence {Name = "케이블 홀더", Description = "직원용 휴게실 쓰레기통에서 피해자 충전기에 꽂혀있던 케이블 홀더가 발견되었다.", Importance = ClueImportance.Minor },
